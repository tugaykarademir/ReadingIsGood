...
public class BookController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/getAllBooks", produces = "application/json", consumes = "application/json")
	public ResponseEntity<List<BookEntity>> getAllBooks() {
		List<BookEntity> response = bookService.getAllBooksList();
		return new ResponseEntity<>(response, HttpStatus.OK);
	}

	@RequestMapping(method = RequestMethod.POST, value = "/getBookByName", produces = "application/json", consumes = "application/json")
	...
	@RequestMapping(method = RequestMethod.POST, value = "/deleteBook", produces = "application/json", consumes = "application/json")
	...
	@RequestMapping(method = RequestMethod.POST, value = "/getBookById", produces = "application/json", consumes = "application/json")
	...
	@RequestMapping(method = RequestMethod.POST, value = "/getSalableBookById", produces = "application/json", consumes = "application/json")
	...
	@RequestMapping(method = RequestMethod.POST, value = "/getBookStock", produces = "application/json", consumes = "application/json")
